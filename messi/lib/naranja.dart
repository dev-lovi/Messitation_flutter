...
class Naranja extends StatefulWidget {
  const Naranja({super.key});

  @override
  // ignore: library_private_types_in_public_api
  NaranjaState createState() => NaranjaState();
}

class NaranjaState extends State<Naranja> {
                ...
                child: Column(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset('images/naranja_cover.png'),
                    ),
                    Padding(
